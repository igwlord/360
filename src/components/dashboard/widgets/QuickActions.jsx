...
const QuickActions = memo(({ onAddQuickTask }) => {
    ...
    return (
        <div className="flex-none grid grid-cols-2 gap-4 h-32">
             ...
             {/* New Project */}
             <div onClick={handleNewProject} className={`group relative overflow-hidden ${theme.cardBg} backdrop-blur-md rounded-[24px] border border-white/10 p-5 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-white/5 transition-all shadow-lg`}>
